...
{
	$sql = "UPDATE customer SET customer_fname='" . $_POST['customer_fname'] . "',customer_lname='" . $_POST['customer_lname'] . "',email_id='" . $_POST['email_id'] . "',address='" . $_POST['address'] . "',state='" . $_POST['state'] . "',city='" . $_POST['city'] . "',landmark='" . $_POST['landmark'] . "',pincode='" . $_POST['pincode'] . "',mobile_no='" . $_POST['mobile_no'] . "' WHERE  customer_id='". $_SESSION['customer_id'] ."'";
